<template>
  <v-row style="position:relative;">
   ...
   <v-row>
      <v-spacer></v-spacer>
        <h1 class="mt-10">Toutes nos destinations en direction de l'Europe</h1>
      <v-spacer></v-spacer>
    </v-row>
            ...
            <v-row style="padding:5px;">
              <v-col cols="6">
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-btn type="success" block outlined color="success" 
        ...
        methods: {
          addToCart(produit){
            ...
            async getData() {
                ...
                this.$fire.firestore.collection('Europe').get().then((querySnapshots) => {
